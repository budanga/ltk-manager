...
pub fn create_project_layer(
    ...
    create_project_layer_inner(project_path, name, description).into()
}

fn create_project_layer_inner(
    project_path: String,
    name: String,
    description: Option<String>,
) -> AppResult<WorkshopProject> {
...
pub fn delete_project_layer(
    ...
    delete_project_layer_inner(project_path, layer_name).into()
}

fn delete_project_layer_inner(
    project_path: String,
    layer_name: String,
) -> AppResult<WorkshopProject> {
    if layer_name == "base" {
...
pub fn update_layer_description(
    ...
    update_layer_description_inner(project_path, layer_name, description).into()
}

fn update_layer_description_inner(
    project_path: String,
    layer_name: String,
    description: Option<String>,
) -> AppResult<WorkshopProject> {
...
pub fn reorder_project_layers(
    ...
    reorder_project_layers_inner(project_path, layer_names).into()
}

fn reorder_project_layers_inner(
    project_path: String,
    layer_names: Vec<String>,
) -> AppResult<WorkshopProject> {
    let path = PathBuf::from(&project_path);
